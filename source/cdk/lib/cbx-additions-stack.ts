...
export class CbxAddition extends cdk.Stack {
    constructor(encodingComplete: LambdaToSns, branch: string, scope: cdk.Construct, id: string, props?: cdk.StackProps) {
        super(scope, id, props);

        const subtitleConversionLambda = new lambda.Function(this, "subtitle-conversion", {
        ...
        const docsAccessRole = iam.Role.fromRoleArn(this, 'Role', 'arn:aws:iam::233403125868:role/Lambda_S3_SQS_Role', {
            mutable: false,
        });

        const videoReadyLambda = new lambda.Function(this, "video-ready", {
            runtime: lambda.Runtime.PYTHON_3_8,
        ...
        const subtitlePublicDocsLambda = new lambda.Function(this, "subtitle-docs", {
        ...
        const subtitlePrivateDocsLambda = new lambda.Function(this, "subtitle-private-docs", {
            runtime: lambda.Runtime.PYTHON_3_7,
        ...
        const subtitleConversionApi = new RestApi(this, `cdn_api`, {
